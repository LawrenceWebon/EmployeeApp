                    ...
                    <div class="container mt-2">
                        <div class="row">
                            <div class="col-lg-12 margin-tb">
                                <div class="pull-left">
                                    <h2>Laravel 10 - CRUD with AJAX</h2>
                                </div>
                                <div class="pull-right mb-2">
                                    <a href="#" class="btn btn-success" onclick="add()"
                                        href="javascript:void(0)">Create Employee</a>
                                </div>
                            </div>
                        </div>
